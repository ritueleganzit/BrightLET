...
import com.eleganzit.brightlet.DocumentEditActivity;
...
public class DocumentsAdapter extends RecyclerView.Adapter<DocumentsAdapter.MyViewHolder>
{
    ...
    public DocumentsAdapter(ArrayList<GetImageFiles> arrayList, Context context, LinearLayout main) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v= LayoutInflater.from(context).inflate(R.layout.documents_layout,parent,false);
    ...
    public void initbottomsheet()
    {
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                context.startActivity(new Intent(context,DocumentEditActivity.class));
            }
        });
