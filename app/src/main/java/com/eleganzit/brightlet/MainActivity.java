...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView.LayoutManager layoutManager=new GridLayoutManager(MainActivity.this,3,LinearLayoutManager.VERTICAL,true);
        //layoutManager.smoothScrollToPosition(grid,null,0);
    ...
    private void sortData(boolean asc)
    {
        ...
        //ADAPTER
        grid.setAdapter(new RecyclerAdapter(images,MainActivity.this));
