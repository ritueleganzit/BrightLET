 ...
 */
public class Fragment_tradesmen_messages extends Fragment {


    public Fragment_tradesmen_messages() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_tradesmen_messages, container, false);
