 ...
 */
public class Fragment_tenants_messages extends Fragment {


    public Fragment_tenants_messages() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_tenants_messages, container, false);
